...
public abstract class AbstractProtocol implements EDProtocol, Churnable, LearningProtocol {
   ...
   * Here we assume that the subclass implements the interface {@link gossipLearning.interfaces.LearningProtocol}
   * for which this helper ABC implementation was designed.<br/>
   * Implementing the interface {@link gossipLearning.interfaces.LearningProtocol} is
   * strongly suggested!
   * 
