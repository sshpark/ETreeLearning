...
//    	double[] temp_instance = ((SparseVector)instance.clone()).toDoubleArray();
//        double maxa = 0.0;
//        for (int i = 0; i < temp_instance.length; i++) maxa = Math.max(maxa, temp_instance[i]);
//        for (int i = 0; i < temp_instance.length; i++) temp_instance[i] -= maxa;
//        
//        Matrix sample = new Matrix(temp_instance, true);
