...
/**
 * This is a random number generator which produces random numbers from the Poisson distribution.<br/>
 ...
 *   The default value of this parameter is 1.0.</li>
 *   <li>The long valued parameter is the seed</li>
 * </ul>
 * 
 * @author ormandi
 *
...
public class PoissonRandom implements Serializable {
  ...
  /**
   * Simply generates the next random number according to the Poisson distribution with parameter lambda.
   * The implementation is similar to that given by Knuth presented at http://en.wikipedia.org/wiki/Poisson_distribution.
   * 
  ...
  /**
   * Returns the current value of parameter lambda.
   *
  ...
  /**
   * Replaces the value of parameter lambda with the given value.
   *
